...
user = os.environ['ME_CONFIG_MONGODB_ADMINUSERNAME']           # username as set for the mongodb admin server (the username used in secret.yaml - before base64 conversion)
password = os.environ['ME_CONFIG_MONGODB_ADMINPASSWORD']       # password as set for the mongodb admin server (the password used in secret.yaml - before base64 conversion)
host = os.environ['ME_CONFIG_MONGODB_SERVER']    # service name of the mongodb admin server as set in the service for mongodb server
